                ...
                <form method="post" action="querypaper.html" class="form-inline" id="searchform">
                    <div>
                        <input style="float:right" type="text" placeholder="输入论文名" class="form-control" id="search"
                            name="searchWord" class="form-control">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <c:forEach items="${papers}" var="paper">
                                <tr>
                                    <td>
                                        <c:out value="${paper.name}"></c:out>
                                    </td>
                                    <td>
                                        <c:out value="${paper.author}"></c:out>
                                    </td>
                                    <td>
                                        <c:out value="${paper.publish}"></c:out>
                                    </td>
                                    <td>
                                        <c:out value="${paper.year}"></c:out>
                                    </td>
                                    <td>
                                        <c:out value="${paper.page}"></c:out>
                                    </td>
                                    <td>
                                        <c:out value="${paper.no}"></c:out>
                                    </td>
                                    <td>
                                        <c:out value="${paper.vol}"></c:out>
                                    </td>
